...
export const PREM_001 = scenario("PREM_001", "Transaction with gasPrice >= 10 Gwei bypasses RLN", "PREMIUM_GAS");

export const PREM_002 = scenario("PREM_002", "Transaction with gasPrice < 10 Gwei requires RLN", "PREMIUM_GAS");

export const PREM_003 = scenario("PREM_003", "Exactly threshold (10 Gwei) bypasses RLN", "PREMIUM_GAS");
