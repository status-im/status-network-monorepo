...
import { StakeTest } from "./Stake.t.sol";
...
contract UnstakeTest is StakeTest {
    ...
    function test_UnstakeOneAccount() public {
        ...
        checkStreamer(
            CheckStreamerParams({
                totalStaked: 2e18, totalMPStaked: 2e18, stakingBalance: 2e18, rewardBalance: 0, rewardIndex: 0
            })
        );
    ...
    function test_UnstakeOneAccountAndAccruedMP() public {
        ...
        checkStreamer(
            CheckStreamerParams({
                totalStaked: 10e18, totalMPStaked: 20e18, stakingBalance: 10e18, rewardBalance: 0, rewardIndex: 0
            })
        );
    ...
    function test_UnstakeMultipleAccounts() public {
        ...
        checkStreamer(
            CheckStreamerParams({
                totalStaked: 20e18, totalMPStaked: 20e18, stakingBalance: 20e18, rewardBalance: 0, rewardIndex: 0
            })
        );
    ...
    function test_UnstakeMultipleAccountsAndRewards() public {
        ...
        checkStreamer(
            CheckStreamerParams({
                totalStaked: 0, totalMPStaked: 0, stakingBalance: 0, rewardBalance: 0, rewardIndex: 125e17
            })
        );
